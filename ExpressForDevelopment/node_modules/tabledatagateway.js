...
var getDBPromis = function(){
  ...
  if (process.argv[2] != undefined && (process.argv[2].startsWith('postgres'))) {
    ...
    try {
      ...
      credentials = 'postgres://' + process.env.DB_USER + ':' + process.env.DB_PASSWORD + '@' + process.env.DB_HOST + ':' + process.env.DB_PORT + '/' + process.env.DB_DATABASENAME + (process.env.DB_SSL=="SSL")?'?ssl=true':'';
    }
  }
