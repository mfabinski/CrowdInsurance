...
//2.3 Schadensfall
//---------------
exports.erstelleSchadensfall = function(versicherungID, beschreibung, schadenshoehe, onSuccess, onError){
  db.func('createschadensfall', [versicherungID,beschreibung,schadenshoehe]).then(onSuccess).catch(onError);
}
