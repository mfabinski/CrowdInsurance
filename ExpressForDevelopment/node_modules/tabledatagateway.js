...
var getDBPromis = function(){
  ...
  if (process.argv[2] != undefined && (process.argv[2].startsWith('postgres'))) {
    ...
    try {
      ...
      credentials = 'postgres://' + process.env.POSTGRES_USER + ':' + process.env.POSTGRES_PASSWORD + '@' + process.env.POSTGRES_HOST + ':' + process.env.POSTGRES_PORT + '/' + process.env.POSTGRES_DB;
    }
  }
