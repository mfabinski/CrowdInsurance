...
exports.selectVersicherungOf = function(personID, onSuccess, onError){
  ...
  db.func('getversicherungpersonbyuid',[versicherungID]).then(onSuccess).catch(onError);
}
...
exports.selectKategorien = function(onSuccess, onError){
  var query = queries.selectKategorien;
...
exports.selectInvestitionOf = function(personID, onSuccess, onError){
  ...
  db.func('getinvestitionkomplettbyuid',[versicherungID]).then(onSuccess).catch(onError);
}
...
exports.selectInvestition = function(investitionID, onSuccess, onError){
  ...
  db.func('getinvestitionkomplettbyiid',[versicherungID]).then(onSuccess).catch(onError);
}
...
exports.erstelleVersicherung = function(personID, name, versicherungshoehe, beitrag, beschreibung, kategorie, onSuccess, onError){
  ...
  db.any(query, [personID, name, versicherungshoehe, beitrag, beschreibung, kategorie]).then(onSuccess).catch(onError);
}
