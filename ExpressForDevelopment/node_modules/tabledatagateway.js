...
// exports.erstelleVersicherung = function(versicherungID, onSuccess, onError){
//   var query1 = queries.insertInvestition; var query2 = queries.insertInvestitionsZahlung;
//   db.any(query,versicherungID).then(onSuccess).catch(onError);
// }
