...
exports.bewertungAbgeben = function(req, res, next) {
    ...
    tdg.getinvestitionbewertung(investitionID,
        function(data){
            logger.info('Kündigung der Investition ' + investitionID + ' erfolgreich eingereicht.');
            res.status(200).json(data);
            bewertung = data.value;
...
//    },
//    function(err){
//        logger.error('Fehler beim Auslesen der InvestitionsID' + err);
//        res.status(500).send('Fehler beim Auslesen der InvestitionsID');
//    });
//    var blub = "fdfkj";
//    if (thumb=='down'){
//        tdg.investition_downvoten(investitionID, function(data) {
//            res.status(200).json('Kündigung der Investition erfolgreich eingereicht.');
//            resolve();
//        },
//        function(err){
//            logger.error('Fehler beim Downvoten der Investition' + err);
//            res.status(500).send('Fehler beim Downvoten der Investition');
//            reject();
//        })
//    }
//    else if (thumb =='up'){
//        tdg.investition_upvoten(function(data){
//            res.status(200).json('Kündigung der Investition erfolgreich eingereicht.');
//            resolve();

//        },
//        function(err) {
//            logger.error('Fehler beim Upvoten der Investition');
//            res.status(500).send('Fehler beim Upvoten der Investition');
//            reject();
//        } );
//        }
