  ...
  tdg.getSchadensfaelleByVersicherung(versicherungID,
    ...
    logger.info('Schadensfaelle der Versicherung ' + versicherungID + 'erfolgreich geladen.');
      if(data.length != 0){
        ...
        res.status(404).send('Versicherung nicht gefunden oder hat keine Schadensfaelle.');
      }
    },
    function(err){
...
exports.getProfilByID = function (req, res, next) {
  var pID = req.params.versicherungID;
  if(pID == undefined){
    pID = personID;
  }
...
exports.erstelleInvestition = function (req, res, next) {
  ...
  var investitionswert = req.body.investitionswert;

  tdg.erstelleInvestition(versicherungID, personID, investitionswert,
    function(data){
...
exports.erstelleSchadensfall = function (req, res, next) {
  ...
  tdg.erstelleSchadensfall(versicherungID, beschreibung, schadenshoehe,
    function(data){
