...
exports.updateVersicherungGekuendigt = 'UPDATE "Versicherung"'
  + ' SET "istGekuendigt"=true, "wirdGekuendigt"=false, "kuendigungsZeitpunkt"=now() WHERE "wirdGekuendigt"=true;'
...
exports.tranVersicherungWirdGekuendigt = 'BEGIN;'
  ...
  + 'UPDATE "Investition" SET "wirdGekuendigt"=true WHERE "versicherungID"=$1;'
  + 'COMMIT;'
