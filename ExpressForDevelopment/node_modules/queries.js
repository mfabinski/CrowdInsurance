...
exports.insertVersicherung = 'INSERT INTO "Versicherung"("personID", name,'
  + ' versicherungshoehe, beitrag, beschreibung, "abschlussZeitpunkt", "istGekuendigt")'
  + ' VALUES ( $1, $2, $3, $4, $5, $6, $7);';

exports.insertInvestition = 'INSERT INTO "Investition"("versicherungID", "personID",'
  + ' "abschlussZeitpunkt", investitionshoehe, "istGekuendigt")'
  + ' VALUES ($1, $2, $3, $4, $5);'

exports.insertInvestitionsZahlung = 'INSERT INTO "Zahlungsstrom"("versicherungID",'
  + ' "personID", zeitpunkt, betrag)'
  + ' VALUES ($1, $2, $3, $4);';

exports.tranInvestieren = 'BEGIN;'
  + exports.insertInvestition
  + exports.insertInvestitionsZahlung
  + 'COMMIT;';
...
exports.getPaymentrelevantInvestitions = 'SELECT "versicherungID", "personID", "investitionshoehe"'
  + ' FROM "Investition" WHERE "istGekuendigt" = false;';
