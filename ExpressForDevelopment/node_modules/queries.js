...
exports.updateVersicherungGekuendigt = 'UPDATE "Versicherung"'
  + ' SET "istGekuendigt"=true, "wirdGekuendigt"=false WHERE "wirdGekuendigt"=true;'
...
//
//4.2 Investition zurueckzahlen und Investition tatsaechlich kuendigen
//---------------------------------------------------------------------
exports.tranInvestitionKuendigen = 'BEGIN;'
  + ' INSERT INTO "Zahlungsstrom"("versicherungID", "personID", betrag)'
  + ' SELECT "versicherungID", "personID", investitionshoehe * (-1) FROM "Investition" WHERE "Investition"."wirdGekuendigt";'
  + exports.updateInvestitionGekuendigt
  + 'COMMIT;'

//
//4.3 Sonstige ;-) //TODO: Kommentare einfuegen
//
